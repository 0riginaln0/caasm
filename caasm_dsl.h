...
/* Lifecycle callbacks (can be repeated inside a state) */
#define BEFORE_ENTER(...) \
...
/* --------------------------------------------------------------------------
 * Transition macros (inside an EVENT)
 * -------------------------------------------------------------------------- */
#define TRANSITIONS(...) \
